...
Definiamo due nuove osservabili chiamate \index{scarti dalla media}\textbf{scarti dalla media} sottraendo i valori medi alle osservabili di partenza:
...
La \index{deviazione standard}\textbf{deviazione standard} $\langle (\delta\hat{\Omega})^2 \rangle$ dei due operatori è dunque:
