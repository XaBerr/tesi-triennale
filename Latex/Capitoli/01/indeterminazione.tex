\lvlii{Principio di indeterminazione}
...
\lvliii{Deduzione formale del principio di indeterminazione}
...
Definiamo due nuove osservabili chiamate \idx{scarti dalla media} sottraendo i valori medi alle osservabili di partenza:
...
La \idx{deviazione standard} $\langle (\delta\hat{\Omega})^2 \rangle$ dei due operatori è dunque:
