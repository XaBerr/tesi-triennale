...
Definiamo due nuove osservabili chiamate \textbf{\index{scarti dalla media}} sottraendo i valori medi alle osservabili di partenza:
...
La \textbf{\index{deviazione standard}} $\langle (\delta\hat{\Omega})^2 \rangle$ dei due operatori è dunque:
