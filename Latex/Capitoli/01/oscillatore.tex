...
dove $g(k)$ prenderà il nome di \myindex{funzione peso} e $\Psi_k$ sarà la famiglia che conterrà le onde che sovrapponendosi formeranno $\Psi$.
...
La \myindex{probabilità di riflessione} è data dal rapporto tra la densità di flusso riflessa e la densità di flusso incidente:
$$R = \frac{|B|^2}{|A|^2}$$
Analogamente la \myindex{probabilità di trasmissione} è data dal rapporto tra densità di fusso trasmessa e densità di flusso incidente:
$$P = \frac{|A''|^2}{|A|^2}$$
...
$$V(x) = \frac{1}{2}kx^2$$
Due cose che si possono notare dalla formula sono: primo il \myindex{potenziale parabolico} è simmertico e il suo asse di simmetria è nel punto $x = 0$, secondo il punto di simmetria è anche il punto di minimo del potenziale e corrisponde a $V(0) = 0$.
