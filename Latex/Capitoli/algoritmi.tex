...
La semi-casualità viene data dalla generazione di un numero casuale $k \in [0,1]$ e dal confrontato con la \idx{distribizione di Boltzman} di parametri: $t = t_{max} - t_{delta} * n$ e $\Delta E = |E_{vicina}| - |E_{attuale}|$.
