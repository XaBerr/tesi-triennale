...
L'algoritmo \textit{discrete time simulated quantum annealing} (DT-SQA)\cite{QVC} chiamto \textit{Santoro-Tosatti-Martonak} o anche come \textit{path integral Monte Carlo}\cite{PIMC} è un'algorimto che cerca di ottenere il valore minimo di energia per IM attraverso a delle modifiche locali della discrettizzazione della dinamica di evoluzione degli spin nel tempo.
